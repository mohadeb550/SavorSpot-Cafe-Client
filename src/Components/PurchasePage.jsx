...
const PurchasePage = () => {
    ...
    const { foodName, category, price, images, country, quantity, description, madeBy , addedUserEmail, ordered} = selectedFood;
                                ...
                                <div className="w-full flex flex-col justify-start items-start space-y-8">
                                    ...
                                    <div className="flex justify-start items-start flex-col space-y-2">
                                        <p className="text-sm md:text-[16px] leading-none font-semibold text-lime-600">
                                            <span className="text-gray-500"> Available Quantity: </span> {quantity}
                                        </p>
                                        <p className="text-sm md:text-[16px] leading-none font-semibold text-lime-600">
                                            <span className="text-gray-500 capitalize"> Category: </span> {category}
                                        </p>
                                        <p className="text-sm md:text-[16px] leading-none font-semibold text-lime-600">
                                            <span className="text-gray-500"> Made By: </span> {madeBy}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                        ...
                        <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                            ...
                            <div className="w-full flex justify-center items-center">
                                <button className="hover:bg-lime-700 py-5 w-96 md:w-full bg-lime-600 text-base font-medium leading-4 text-white"> Purchase Now </button>
                            </div>
                        </div>
                    </div>
                </div>
